...
var myFullTime = prompt('Будь ласка, введіть скільки часу ви б хотіли виділити на коструювання.');
var myStepsAmount = prompt('Введіть загальну кількість кроків в інструкції.');
var timePerStep = myFullTime/myStepsAmount

var curTime = new Date()

var endTime = curTime.getTime() + (myFullTime * 60 * 1000) // convert minutes in milliseconds explicitly
